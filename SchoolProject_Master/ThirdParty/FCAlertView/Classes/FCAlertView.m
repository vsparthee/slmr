...
- (void)drawRect:(CGRect)rect {
    ...
    if (alertTextFields.count > 0) {
        ...
        _textField.font = [UIFont fontWithName:@"Century Gothic-Regular" size:12];
    ...
    if (_numberOfButtons == 0) { // View only contains DONE/DISMISS Button
        ...
        doneButton.titleLabel.font = [UIFont fontWithName:@"Century Gothic-Regular" size:15.0f];
        ...
        otherButton.titleLabel.font = [UIFont fontWithName:@"Century Gothic-Regular" size:15.0f];
        ...
        firstButton.titleLabel.font = [UIFont fontWithName:@"Century Gothic-Regular" size:15.0f];
        ...
        secondButton.titleLabel.font = [UIFont fontWithName:@"Century Gothic-Regular" size:15.0f];
...
- (void) showAlertInView1:(UIView *)view withTitle:(NSString *)title withSubtitle:(NSString *)subTitle withCustomImage:(UIImage *)image withDoneButtonTitle:(NSString *)done andButtons:(NSArray *)buttons {
    ...
    if (_blurBackground && NSClassFromString(@"UIVisualEffectView") != nil) {
        ...
        backgroundVisualEffectView.frame = view.bounds;
